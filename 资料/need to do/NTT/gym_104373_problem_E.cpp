...
const int G = 6, mod = 180143985094819841, Maxn = 5e5 + 10;
...
void solve() {
	...
	std::vector<std::vector<int> > cir(400, std::vector<int>(400));
	std::vector<int> pos(n + 1, -1), q(m), ans(m);
	for (int i = 0; i < m; i ++) {
		std::cin >> q[i];
	}
	int cnt = -1;
